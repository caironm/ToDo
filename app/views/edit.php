<?php
	...
	require_once "app/views/templates/auto-header.php";
?>
...
<div id="edit" class="uk-modal">
    <div class="uk-modal-dialog">
        ...
        <form class="uk-form" method="post" action=".\..\..\edit\<?php echo $sAllbyid[0]['id']; ?>">

		    <fieldset data-uk-margin>
		        <legend><?php echo $lang['editTitle']; ?></legend>
		        <div class="uk-form-row">
		        	<input class="uk-width-1-1 uk-form-large" type="text" name="name" placeholder="<?php echo $lang['homeNewName']; ?>" 
		        	value="<?php echo $sAllbyid[0]['name']; ?>">
		        </div>
		       
		        <div class="uk-form-row">
		        	<textarea class="uk-width-1-1" rows="4" name="info" placeholder="<?php echo $lang['homeNewInfo']; ?>"
		        	><?php echo $sAllbyid[0]['info']; ?></textarea>
		        </div>

		        	<input type="hidden" name="lang" value="<?php echo $langs ?>">

		        <div class="uk-form-row">
		        	<button class="uk-button uk-button-large uk-button-primary" type="submit"><?php echo $lang['editButton']; ?></button>
		        </div>
		    </fieldset>
...
<?php
	require_once "app/views/templates/auto-footer.php";
?>
